...
public interface MetaChartSourceItemMapper {
    ...
    void copyProperties(@MappingTarget MetaChartSourceItemPO target, MetaChartSourceItemPO source);
    ...
    void setAggOrderUpdateDTO(@MappingTarget AggOrderPO po, AggOrderUpdateDTO updateDTO);

    void setDetailColumnUpdateDTO(@MappingTarget DetailColumnPO po, DetailColumnUpdateDTO updateDTO);

    void setDetailOrderUpdateDTO(@MappingTarget DetailOrderPO po, DetailOrderUpdateDTO updateDTO);

    void setDimensionUpdateDTO(@MappingTarget DimensionPO po, DimensionUpdateDTO updateDTO);

    void setHavingUpdateDTO(@MappingTarget HavingPO po, HavingUpdateDTO updateDTO);

    void setMetricsUpdateDTO(@MappingTarget MetricsPO po, MetricsUpdateDTO updateDTO);

    void setWhereUpdateDTO(@MappingTarget WherePO po, WhereUpdateDTO updateDTO);
    ...
    @Mappings({@Mapping(target = "key"), @Mapping(target = "joinIndex"), @Mapping(target = "type"), @Mapping(target = "parentId"), @Mapping(target = "parentKey"), @Mapping(target = "feature"),})
