...
public interface TemplateFileAPI {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "templateFileAddDTO", dataType = "TemplateFileAddDTO", value = "新增【模板文件】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "templateId", dataType = "int", value = "模板id", paramType = "query"), @ApiImplicitParam(name = "fileDir", dataType = "string", value = "文件目录", paramType = "query"),})
    ResponseEntity<TemplateFileShowVO> upload(Integer templateId, String fileDir, MultipartFile file) throws Exception;

    /**
     * 修改【模板文件】
     */
    @ApiOperation(value = "修改【模板文件】")
    @ApiImplicitParams({@ApiImplicitParam(name = "templateFileUpdateDTO", dataType = "TemplateFileUpdateDTO", value = "修改【模板文件】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "fileId", dataType = "int", value = "【模板文件】id", paramType = "path"), @ApiImplicitParam(name = "dto", dataType = "TemplateFileContentUpdateDTO", value = "修改【模板文件内容】参数", paramType = "body"),})
    ResponseEntity<Integer> updateContent(Integer fileId, TemplateFileContentUpdateDTO dto);
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "fileId", dataType = "int", value = "【模板文件】id", paramType = "path"),})
