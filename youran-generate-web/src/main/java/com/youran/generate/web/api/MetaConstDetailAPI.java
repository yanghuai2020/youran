...
public interface MetaConstDetailAPI {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "metaConstDetailAddDTO", dataType = "MetaConstDetailAddDTO", value = "新增常量值参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "metaConstDetailUpdateDTO", dataType = "MetaConstDetailUpdateDTO", value = "修改常量值参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "metaConstDetailQO", dataType = "MetaConstDetailQO", value = "查询参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "constDetailId", dataType = "int", value = "常量值id", paramType = "path"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "constDetailId", dataType = "int", value = "常量值id数组", paramType = "body"),})
