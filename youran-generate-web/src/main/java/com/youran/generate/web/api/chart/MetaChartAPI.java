...
public interface MetaChartAPI {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "AggTableAddDTO", value = "新增【聚合表】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "AggTableUpdateDTO", value = "修改【聚合表】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "chartId", dataType = "int", value = "【聚合表】id", paramType = "path"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "DetailListAddDTO", value = "新增【明细表】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "DetailListUpdateDTO", value = "修改【明细表】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "chartId", dataType = "int", value = "【明细表】id", paramType = "path"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "BarLineAddDTO", value = "新增【柱线图】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "BarLineUpdateDTO", value = "修改【柱线图】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "chartId", dataType = "int", value = "【柱线图】id", paramType = "path"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "PieAddDTO", value = "新增【饼图】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "PieUpdateDTO", value = "修改【饼图】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "chartId", dataType = "int", value = "【饼图】id", paramType = "path"),})
