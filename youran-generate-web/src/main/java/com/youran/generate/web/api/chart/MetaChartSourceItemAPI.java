...
public interface MetaChartSourceItemAPI {
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "AggOrderAddDTO", value = "新增【聚合排序】参数", paramType = "body"),})
    ResponseEntity<AggOrderVO> saveAggOrder(AggOrderAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【明细列】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "DetailColumnAddDTO", value = "新增【明细列】参数", paramType = "body"),})
    ResponseEntity<DetailColumnVO> saveDetailColumn(DetailColumnAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【明细排序】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "DetailOrderAddDTO", value = "新增【明细排序】参数", paramType = "body"),})
    ResponseEntity<DetailOrderVO> saveDetailOrder(DetailOrderAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【维度】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "DimensionAddDTO", value = "新增【维度】参数", paramType = "body"),})
    ResponseEntity<DimensionVO> saveDimension(DimensionAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【having条件】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "HavingAddDTO", value = "新增【having条件】参数", paramType = "body"),})
    ResponseEntity<HavingVO> saveHaving(HavingAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【指标】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "MetricsAddDTO", value = "新增【指标】参数", paramType = "body"),})
    ResponseEntity<MetricsVO> saveMetrics(MetricsAddDTO addDTO) throws Exception;

    @ApiOperation(value = "新增【where条件】")
    @ApiImplicitParams({@ApiImplicitParam(name = "addDTO", dataType = "WhereAddDTO", value = "新增【where条件】参数", paramType = "body"),})
    ...
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "AggOrderUpdateDTO", value = "修改【聚合排序】参数", paramType = "body"),})
    ResponseEntity<AggOrderVO> updateAggOrder(AggOrderUpdateDTO updateDTO);

    @ApiOperation(value = "修改【明细列】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "DetailColumnUpdateDTO", value = "修改【明细列】参数", paramType = "body"),})
    ResponseEntity<DetailColumnVO> updateDetailColumn(DetailColumnUpdateDTO updateDTO);

    @ApiOperation(value = "修改【明细排序】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "DetailOrderUpdateDTO", value = "修改【明细排序】参数", paramType = "body"),})
    ResponseEntity<DetailOrderVO> updateDetailOrder(DetailOrderUpdateDTO updateDTO);

    @ApiOperation(value = "修改【维度】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "DimensionUpdateDTO", value = "修改【维度】参数", paramType = "body"),})
    ResponseEntity<DimensionVO> updateDimension(DimensionUpdateDTO updateDTO);

    @ApiOperation(value = "修改【having条件】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "HavingUpdateDTO", value = "修改【having条件】参数", paramType = "body"),})
    ResponseEntity<HavingVO> updateHaving(HavingUpdateDTO updateDTO);

    @ApiOperation(value = "修改【指标】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "MetricsUpdateDTO", value = "修改【指标】参数", paramType = "body"),})
    ResponseEntity<MetricsVO> updateMetrics(MetricsUpdateDTO updateDTO);

    @ApiOperation(value = "修改【where条件】")
    @ApiImplicitParams({@ApiImplicitParam(name = "updateDTO", dataType = "WhereUpdateDTO", value = "修改【where条件】参数", paramType = "body"),})
