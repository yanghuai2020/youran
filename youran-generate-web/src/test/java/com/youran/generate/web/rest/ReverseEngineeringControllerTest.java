...
public class ReverseEngineeringControllerTest extends AbstractWebTest {
    ...
    public void execute() throws Exception {
        ...
        restMockMvc.perform(post(getApiPath() + "/reverse_engineering/check").contentType(MediaType.APPLICATION_JSON).content(JsonUtil.toJSONString(dto))).andExpect(MockMvcResultMatchers.status().isOk());

        restMockMvc.perform(post(getApiPath() + "/reverse_engineering/execute").contentType(MediaType.APPLICATION_JSON).content(JsonUtil.toJSONString(dto))).andExpect(MockMvcResultMatchers.status().isOk());
    }
